...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <div className="w-14 h-14 md:w-16 md:h-16 bg-[#25D366] rounded-2xl flex items-center justify-center shadow-soft hover:shadow-[0_0_30px_rgba(37,211,102,0.4)] transition-all duration-pro-base relative overflow-hidden">
